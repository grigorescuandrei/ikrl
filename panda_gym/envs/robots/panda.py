...
class Panda(PyBulletRobot):
    ...
    def get_obs(self) -> np.ndarray:
        # end-effector position, rotation and velocity
        ...
        if not self.block_gripper:
            fingers_width = self.get_fingers_width()
            obs = np.concatenate((ee_position, ee_rotation, ee_velocity, [fingers_width]))
        else:
            obs = np.concatenate((ee_position, ee_rotation, ee_velocity))
        return obs
    ...
    def set_joint_random(self) -> None:
        ...
        self.set_joint_angles(random_joint_values)
    ...
    def get_ee_rotation(self) -> np.ndarray:
        """Returns the rotation of the end-effector as (rx, ry, rz, w)"""
        return self.get_link_rotation(self.ee_link)
